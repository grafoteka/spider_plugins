...
DiffDrivePlugin18servos::DiffDrivePlugin18servos(){
	...
	gait_control_sub = node.subscribe<crab_msgs::GaitCommand>("/teleop/gait_control", 1, &DiffDrivePlugin18servos::teleopGaitCtrl, this);
...
void DiffDrivePlugin18servos::chatterLegsState (const crab_msgs::LegsJointsStateConstPtr &legs_jnts){
	...
	if (gait_command.cmd == gait_command.BACKLEGBROKEN){
		servo_position[5][0] = rotation_direction[s_num]*0* limit_coef/12.7;
		servo_position[5][1] = rotation_direction[s_num]*-4* limit_coef/6.85;
		servo_position[5][2] = rotation_direction[s_num]*0* limit_coef/6.85;
	}
	else if (gait_command.cmd == gait_command.MIDDLELEGBROKEN){
		servo_position[1][0] = rotation_direction[s_num]*0* limit_coef/12.7;
		servo_position[1][1] = rotation_direction[s_num]*4* limit_coef/6.85;
		servo_position[1][2] = rotation_direction[s_num]*0* limit_coef/6.85;
	}
	else if (gait_command.cmd == gait_command.FOURLEGMOVEMENT){
		servo_position[2][0] = rotation_direction[s_num]*0* limit_coef/12.7;
		servo_position[2][1] = rotation_direction[s_num]*4* limit_coef/6.85;
		servo_position[2][2] = rotation_direction[s_num]*0* limit_coef/6.85;
...
void DiffDrivePlugin18servos::teleopGaitCtrl (const crab_msgs::GaitCommandConstPtr &gait_cmd){
...
void DiffDrivePlugin18servos::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  joints[CR1]->SetForce(0, torque);
  joints[CR2]->SetForce(0, torque);
  joints[CR3]->SetForce(0, torque);
  joints[CL1]->SetForce(0, torque);
  joints[CL2]->SetForce(0, torque);
  joints[CL3]->SetForce(0, torque);
  joints[FR1]->SetForce(0, torque);
  joints[FR2]->SetForce(0, torque);
  joints[FR3]->SetForce(0, torque);
  joints[FL1]->SetForce(0, torque);
  joints[FL2]->SetForce(0, torque);
  joints[FL3]->SetForce(0, torque);
  joints[TR1]->SetForce(0, torque);
  joints[TR2]->SetForce(0, torque);
  joints[TR3]->SetForce(0, torque);
  joints[TL1]->SetForce(0, torque);
  joints[TL2]->SetForce(0, torque);
  joints[TL3]->SetForce(0, torque);
...
//std::cout << "Valor de angulo:" << (float) servo_position[0][0]*pi/180 << "\n";
  ...
  joints[CR1]->SetVelocity(0, 0); joints[CR1]->SetPosition(0, (float) servo_position[0][0]*pi/180);
  joints[CR2]->SetVelocity(0, 0); joints[CR2]->SetPosition(0, (float) servo_position[1][0]*pi/180);
  joints[CR3]->SetVelocity(0, 0); joints[CR3]->SetPosition(0, (float) servo_position[2][0]*pi/180);
  joints[CL1]->SetVelocity(0, 0); joints[CL1]->SetPosition(0, (float) servo_position[3][0]*pi/180);
  joints[CL2]->SetVelocity(0, 0); joints[CL2]->SetPosition(0, (float) servo_position[4][0]*pi/180);
  joints[CL3]->SetVelocity(0, 0); joints[CL3]->SetPosition(0, (float) servo_position[5][0]*pi/180);
  joints[FR1]->SetVelocity(0, 0); joints[FR1]->SetPosition(0, (float) -servo_position[0][1]*pi/180);
  joints[FR2]->SetVelocity(0, 0); joints[FR2]->SetPosition(0, (float) -servo_position[1][1]*pi/180);
  joints[FR3]->SetVelocity(0, 0); joints[FR3]->SetPosition(0, (float) -servo_position[2][1]*pi/180);
  joints[FL1]->SetVelocity(0, 0); joints[FL1]->SetPosition(0, (float) servo_position[3][1]*pi/180);
  joints[FL2]->SetVelocity(0, 0); joints[FL2]->SetPosition(0, (float) servo_position[4][1]*pi/180);
  joints[FL3]->SetVelocity(0, 0); joints[FL3]->SetPosition(0, (float) servo_position[5][1]*pi/180);
  joints[TR1]->SetVelocity(0, 0); joints[TR1]->SetPosition(0, (float) -servo_position[0][2]*pi/180);
  joints[TR2]->SetVelocity(0, 0); joints[TR2]->SetPosition(0, (float) -servo_position[1][2]*pi/180);
  joints[TR3]->SetVelocity(0, 0); joints[TR3]->SetPosition(0, (float) -servo_position[2][2]*pi/180);
  joints[TL1]->SetVelocity(0, 0); joints[TL1]->SetPosition(0, (float) servo_position[3][2]*pi/180);
  joints[TL2]->SetVelocity(0, 0); joints[TL2]->SetPosition(0, (float) servo_position[4][2]*pi/180);
  joints[TL3]->SetVelocity(0, 0); joints[TL3]->SetPosition(0, (float) servo_position[5][2]*pi/180);
